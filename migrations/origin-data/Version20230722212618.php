 ...
 */
final class Version20230722212618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employees ADD company_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BA82C300979B1AD6 ON employees');
        $this->addSql('ALTER TABLE employees DROP company_id');
    }
}
